...
replace (
	...
	github.com/pingcap/log => github.com/suuyaoo/zlog-go v0.0.0-20250102022349-ce291d848b32
	go.etcd.io/etcd => github.com/suuyaoo/etcd v0.34.28-0.20250104094941-2439b20e1383
)
